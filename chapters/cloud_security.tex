...
The T-Pot has been deployed for three weeks (from \nth{26} of September to \nth{16} of October) and collected in total \numprint{607747} attacks.
...
Respectively, no stateless packet filter has been applied to the T-Pot for three weeks (\nth{2} of December until \nth{23} of December).
...
Interestingly, zero-day exploits like the Apache vulnerability \cite{CVE-2021-42013} that came with version $2.49.0$ got registered in CVE on the \nth{6} of October and immediately recognized by Suricata on the \nth{15} of October.
...
The logs could trace back similar attacks like \verb|/cgi-bin/.\%2e/\%2e\%2e/bin/sh| until the \nth{7} of October, leaving an even smaller time frame to adapt to new exposures.
...
\Autoref{chap:fingerprinting} will present a way to avoid such fingerprint activities with the honeypot Cowrie.
