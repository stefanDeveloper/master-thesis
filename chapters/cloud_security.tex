...
\chapter{Measuring Botnet activities in the Cloud}
...
In this chapter, we want to compare the findings \citet{Kelly2021} claimed in the paper \enquote{A Comparative Analysis of Honeypots on Different Cloud Platforms} with ours using the University Heidelberg's cloud solution.
...
We want to verify that most of the attacks on the Internet are originated from botnets.
...
Our T-Pot has been deployed for 3 weeks (from 22nd of September to 22nd of October) and collected in total \numprint{825,539} attacks.
Overall, RDPY ($49.15\%$), Honeytrap ($32.01\%$), and Cowrie ($11.97\%$) received most of the attacks with a total amount of \numprint{540,398} attacks.
...
We assume that attacks by botnets have increased significantly since last year when \citet{Kelly2021} did their research.
...
This phenomenon shows that nearly all attacks originate from botnets which scan through IP address ranges.
...
It shows that recent botnet activities can be traced to find the newest trends of attacks.
...
\begin{sidewaystable}
    ...
    \begin{tabularx}{\linewidth}{l|XX|XX|XX|XX}
        ...
        Conpot             & $807$                                  & $0.10\%$                                & -                                & -                                  & -               & -             & -               & -             \\
        Cowrie             & $98813$                                & $11.97\%$                               & 4503                             & $1.46\%$                           & 297818          & $51.25\%$     & 9012            & $2.64\%$      \\
        DDoSPot            & $0$                                    & $0\%$                                   & -                                & -                                  & -               & -             & -               & -             \\
        Dicompot           & $27$                                   & $0\%$                                   & -                                & -                                  & -               & -             & -               & -             \\
        Dionaea            & $3293$                                 & $0.40\%$                                & 288075                           & $93.49\%$                          & 162570          & $27.98\%$     & 308102          & $90.42\%$     \\
        Elasticpot         & $531$                                  & $0.06\%$                                & -                                & -                                  & -               & -             & -               & -             \\
        Glutton            & $0$                                    & $0\%$                                   & 11878                            & $3.85\%$                           & 84375           & $15.52\%$     & 17256           & $5.06\%$      \\
        Heralding          & $35843$                                & $4.34\%$                                & 1885                             & $0.61\%$                           & 12255           & $2.11\%$      & 3370            & $0.99\%$      \\
        HoneyPy            & $0$                                    & $0\%$                                   & 172                              & $0.06\%$                           & 2149            & $0.37\%$      & 497             & $0.15\%$      \\
        HoneySAP           & $18$                                   & $0\%$                                   & -                                & -                                  & -               & -             & -               & -             \\
...
In order to identify any bottlenecks, a thorough code review of T-Pot has been done.
One downside is the static hostname representation of Cowrie.
It always gives responds with \verb|#1 SMP Debian 3.2.68-1+deb7u1| (\verb|uname -a|), leaving a tiny footprint when botnets crawl through the web.
A random choice of the default hostname could harden the honeypot from being exposed.
Next, if attackers could check open ports on T-Pot, it might be suspicious when many ports with services are widely open.
From a technical perspective, bots could check this state, and thus, exclude T-Pot from being probed.
However, T-Pot included good 
One of it 
...
\citet{vetterl2020} states that attackers always try to prevent their methods, exploits and tools to be disclosed, and thus, avoiding honeypots whenever it is possible.
