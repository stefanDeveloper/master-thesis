...
\Autoref{chap:cloud-security}, \textit{Analyze Honeypot Attacks in the Cloud}, presents the status quo of malicious activities in heiCLOUD.
...
\Autoref{chap:fingerprinting}, \textit{Mitigate Fingerprint Activities of Honeypots}, presents two experiments.
