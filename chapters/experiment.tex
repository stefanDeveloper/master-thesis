...
Lastly, we present a concept to disguise Cowrie, and test if it disguises our honeypot successfully.
...
For example, Cowrie version $1.1.0$ missed \verb|tftp|\footnote{Trivial File Transfer Protocol (TFTP) is a lockstep File Transfer Protocol} and came with version $1.2.0$.
