...
\autoref{lst:sip-exploitation} and \autoref{lst:smb-exploitation} outlines two interesting payloads.
...
CVE-2020-11899 accounts nearly $99\%$ with a total number of $\numprint{102,838}$.
Adversary could send malformed IPv6 packet to cause an Out-of-bounds Read resulting in a potential denial of service.
TCP stack $6.0.1.66$
CVE-2002-0013 
CVE-2019-12263
...
Neither T-Pot nor MADCAT could identify any significant behavior.

Our results give an inside of the value of honeypots in a restricted network zone.
We have shown that 
