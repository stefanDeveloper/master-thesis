...
Dozen of defintions for honeypots circulate through the web. Thus, to cope with all the subtle differences, we want to exhibit some of the definitions and narrow down a common one. One of the well-known experts Lance Spitz defines honeypots as a \enquote{security resource whose value lies in being probed, attacked, or compromised.}\cite{Spitzner2003}
...
Furthermore we distinguish honeypots in  \autoref{subsec:classification-honeypots}
