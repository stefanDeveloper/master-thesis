...
\begin{figure}
    \lstinputlisting[language=bash, caption={[MADCAT connection attempt to exploit \ac{sip} connection]MADCAT connection attempt to exploit \ac{sip} connection. Received on the 16th of November. \ac{ip} reputation: known attacker. Location Germany.}, label={lst:sip-exploitation}]{listings/exploit-sip.txt}
\end{figure}
...
\begin{figure}
    \lstinputlisting[language=bash, caption={[MADCAT connection attempt to exploit \ac{smb} connection]MADCAT connection attempt to exploit \ac{smb} connection. Received on the 16th of November. \ac{ip} reputation: known attacker. Location Germany.}, label={lst:smb-exploitation}]{listings/exploit-smb.txt}
\end{figure}
