...
Newer versions might be available and could differ from ours.

Albeit the sheer quantity of honeypots that are used in T-Pot, we want to share some basic knowledge about them. 
\autoref{tab:overview-honeypots} gives a quick overview of all available honeypots in conjunction with the port they are running on, service type, interaction level, and a short decription.
