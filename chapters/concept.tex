...
All of these received packets have a resolved IP address in the subnet \ipAddress{129.206.0.0/16}, thus, it remains unclear if the connection is malicious or .
Overall, most requested IP addresses are \ipAddress{129.206.217.118}, \ipAddress{129.206.218.23}, and \ipAddress{129.206.218.194}.
...
The statement from \citet{Spitzner2003} that honeypots only receive little 
