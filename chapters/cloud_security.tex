...
The overall results show an average ratio of \numprint{55000} attacks per day, summing up to roughly $1.3$ million in total.
...
%Due to completeness, the results are left out and do not show the filtered data.
