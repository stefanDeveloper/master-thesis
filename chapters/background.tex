...
In this section, we want to give basic unterstandings of cloud computing. To do so, . Lastly, we give an short introduction to HeiCloud, an offered by Heidelberg University.\todo{Fix introduction}
...
Service models Examples for such service models can be derived from \autoref{tab:example-service-models}. \autoref{fig:cloud-functionalities}\todo{more introduction}\\
