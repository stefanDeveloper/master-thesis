...
Our instances are located in the building with IP addresses \ipAddress{129.206.219.62} and \ipAddress{129.206.219.88}.
...
These \ac{snmp} requests affiliate with day-to-day traffic in an internal network, and thus, are not suspicious.
...
Besides the subtle output we have received, our results have given an insight of the value of honeypots in a restricted network zone.
...
In comparison to our T-Pot which has been used in heiCLOUD, our results are as expected delicate and data analysis turns out to be more detailed.
The statement from \citet{Spitzner2003} that honeypots only receive little input and nearly every input is suspicious matches our results only half way.
