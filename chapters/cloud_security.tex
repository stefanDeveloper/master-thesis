...
Overall, RDPY ($49.15\%$), HoneyTrap ($32.01\%$), and Cowire ($11.97\%$) received most of the attacks with a total amount of \numprint{540,398} attacks.
...
We clearly identify a bias towards remote desktop protocol attacks, shell code exploitation, and commands retrieve information about CPU, scheduled tasks (\ipAddress{cat /proc/cpuinfo}, or \ipAddress{crontab}), or privilege escalation.
...
The third most of it is CVE-2012-0152, which enables attackers for RDP in Microsoft Windows Server 2008 R2 and R2 SP1 and Windows 7 Gold and SP1 to cause a denial of service by sending a series of crafted packets.
...
Furthermore, lack of updates and outdated servers using \ac{rdp} remain an ease vulnerability for automatic attacks scanning the web and trying to find exposures.
...
\textbf{Suricata} registered several alerts and CVEs.
The vast majority of alerts are RDP related policies, VNC 
Most used vulnerabilities are 
\begin{enumerate*}[label=(\roman*)]
    \item CVE-2001-0540\cite{CVE-2001-0540},
    \item CVE-2006-2369\cite{CVE-2006-2369},
    \item CVE-2012-0152\cite{CVE-2012-0152}, and
\end{enumerate*}.
The first one is a memory leak in Terminal servers in Windwos NT and Windows 2000 causing a denial of service (memory exhaustion) by misformed RDP requests.
Next one is a RealVNC vulnerability allowing hackers to bypass authentication.
...
We could trace back similar attacks like \ipAddress{/cgi-bin/.\%2e/\%2e\%2e/bin/sh} until the 7th of October, leaving an even smaller time frame to adapt to new exposures.
...
Besides default credentials to log in, adversaries used various commands to retrieve any information about the host system.
